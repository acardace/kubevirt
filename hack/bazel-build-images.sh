...
bazel build \
    ...
    //cmd/virt-controller:virt-controller-image //cmd/virt-handler:virt-handler-image //cmd/virt-launcher:virt-launcher-image //tests:conformance_image //cmd/virt-operator:virt-operator-image-debug
